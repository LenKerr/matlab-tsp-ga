% MTSP_GA_MINSUM Multiple Traveling Salesmen Problem (M-TSP) Genetic Algorithm (GA)
...
%     mtsp_ga_minsum
%       -or-
%     mtsp_ga_minsum(userConfig)
%       -or-
%     resultStruct = mtsp_ga_minsum;
%       -or-
%     resultStruct = mtsp_ga_minsum(userConfig);
%       -or-
%     [...] = mtsp_ga_minsum('Param1',Value1,'Param2',Value2, ...);
%
% Example:
...
function varargout = mtsp_ga_minsum(varargin)
    ...
    if showProg
        hFig = figure('Name','MTSP_GA_MINSUM | Current Best Solution','Numbertitle','off');
        hAx = gca;
        if showStatus
    ...
    if showResult
        ...
        % Plots
        %
        figure('Name','MTSP_GA_MINSUM | Results','Numbertitle','off');
        subplot(2,2,1);
