%TSP_GA_HYBRID Traveling Salesman Problem (TSP) Genetic Algorithm (GA)
...
%       -or-
%     resultStruct = tsp_ga_hybrid;
%       -or-
%     resultStruct = tsp_ga_hybrid(userConfig);
%       -or-
%     [...] = tsp_ga_hybrid('Param1',Value1,'Param2',Value2, ...);
%
% Example:
...
function varargout = tsp_ga_hybrid(varargin)
    ...
    if showProg
        hFig = figure('Name','TSP_GA_HYBRID | Current Best Solution','Numbertitle','off');
        hAx = gca;
        if showStatus
    ...
    if showResult
        ...
        % Plot the GA results
        %
        figure('Name','TSP_GA_HYBRID | Results','Numbertitle','off');
        subplot(2,2,1);
