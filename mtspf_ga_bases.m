% MTSPF_GA_BASES Multiple Traveling Salesmen Problem (M-TSP) Genetic Algorithm (GA)
...
%     3. Salesmen have individual "base" cities which they start/stop at
%
% Input:
...
%     Taken together, these represent the solution [1 5 6 9 1][2 4 8 2][3 10 7 3],
%     which designates the routes for the 3 salesmen as follows:
%         . Salesman 1 travels from city 1 to 5 to 6 to 9 and back to 1
%         . Salesman 2 travels from city 2 to 4 to 8 and back to 2
%         . Salesman 3 travels from city 3 to 10 to 7 and back to 3
%
% Usage:
%     mtspf_ga_bases
%       -or-
%     mtspf_ga_bases(userConfig)
%       -or-
%     resultStruct = mtspf_ga_bases;
%       -or-
%     resultStruct = mtspf_ga_bases(userConfig);
%       -or-
%     [...] = mtspf_ga_bases('Param1',Value1,'Param2',Value2, ...);
%
% Example:
...
%     resultStruct = mtspf_ga_bases(userConfig);
%
% See also: tsp_ga, mtsp_ga, mtspf_ga, mtspo_ga, mtspof_ga, mtspofs_ga
%
% Author: Joseph Kirk
% Email: jdkirk630@gmail.com
%
function varargout = mtspf_ga_bases(varargin)
    ...
    if showProg
        hFig = figure('Name','MTSPF_GA_BASES | Current Best Solution', ...
    ...
    for iter = 1:numIter
        ...
        if (minDist < globalMin)
            ...
            if showProg
                ...
                %
                for s = 1:nSalesmen
                    rte = [s optRoute(rng(s,1):rng(s,2)) s];
    ...
    rng = [[1 optBreak+1];[optBreak n]]';
    for s = 1:nSalesmen
        optSolution{s} = [s optRoute(rng(s,1):rng(s,2)) s];
    end
    ...
    if showResult
        ...
        % Plot the GA results
        %
        figure('Name','MTSPF_GA_BASES | Results','Numbertitle','off');
        subplot(2,2,1);
        ...
        subplot(2,2,2);
        s = (1:nSalesmen);
        imagesc(dmat([s optRoute],[s optRoute]));
