% MTSPF_GA_MINMAX Fixed Multiple Traveling Salesmen Problem (M-TSP) Genetic Algorithm (GA)
...
%     mtspf_ga_minmax
%       -or-
%     mtspf_ga_minmax(userConfig)
%       -or-
%     resultStruct = mtspf_ga_minmax;
%       -or-
%     resultStruct = mtspf_ga_minmax(userConfig);
%       -or-
%     [...] = mtspf_ga_minmax('Param1',Value1,'Param2',Value2, ...);
%
% Example:
...
%
function varargout = mtspf_ga_minmax(varargin)
    ...
    if showProg
        hFig = figure('Name','MTSPF_GA_MINMAX | Current Best Solution','Numbertitle','off');
        hAx = gca;
        if showStatus
    ...
    for iter = 1:numIter
        ...
        for p = 1:popSize
            ...
            for s = 1:nSalesmen
                d = dmat(1,pRoute(rng(s,1))); % Add start distance
    ...
    if showResult
        ...
        % Plots
        %
        figure('Name','MTSPF_GA_MINMAX | Results','Numbertitle','off');
        subplot(2,2,1);
