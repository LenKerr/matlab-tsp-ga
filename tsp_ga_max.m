%TSP_GA_MAX Traveling Salesman Problem (TSP) Genetic Algorithm (GA)
%   Finds a (near) optimal solution to the TSP by setting up a GA to search
%   for the LONGEST route (GREATEST distance for the salesman to travel to
...
%     - MAXDIST (scalar float) is the cost of the best route
%
% Usage:
%     tsp_ga_max
%       -or-
%     tsp_ga_max(userConfig)
%       -or-
%     resultStruct = tsp_ga_max;
%       -or-
%     resultStruct = tsp_ga_max(userConfig);
%       -or-
%     [...] = tsp_ga_max('Param1',Value1,'Param2',Value2, ...);
%
% Example:
...
%
function varargout = tsp_ga_max(varargin)
    ...
    if showProg
        hFig = figure('Name','TSP_GA_MAX | Current Best Solution', ...
    ...
    if showResult
        ...
        % Plot the GA results
        %
        figure('Name','TSP_GA_MAX | Results','Numbertitle','off');
        subplot(2,2,1);
