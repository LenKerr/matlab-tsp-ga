% MTSP_GA_MINMAX Multiple Traveling Salesmen Problem (M-TSP) Genetic Algorithm (GA)
...
%     mtsp_ga_minmax
%       -or-
%     mtsp_ga_minmax(userConfig)
%       -or-
%     resultStruct = mtsp_ga_minmax;
%       -or-
%     resultStruct = mtsp_ga_minmax(userConfig);
%       -or-
%     [...] = mtsp_ga_minmax('Param1',Value1,'Param2',Value2, ...);
%
% Example:
...
%
function varargout = mtsp_ga_minmax(varargin)
