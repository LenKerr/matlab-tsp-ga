% MTSPVOF_GA Fixed Endpoints Open Variable Multiple Traveling Salesmen Problem (M-TSP) Genetic Algorithm (GA)
...
%   the start location to unique individual cities and finally to the end location)
%
% Summary:
...
%     mtspvof_ga
%       -or-
%     mtspvof_ga(userConfig)
%       -or-
%     resultStruct = mtspvof_ga;
%       -or-
%     resultStruct = mtspvof_ga(userConfig);
%       -or-
%     [...] = mtspvof_ga('Param1',Value1,'Param2',Value2, ...);
%
% Example:
...
function varargout = mtspvof_ga(varargin)
    ...
    if showProg
        figure('Name','MTSPVOF_GA | Current Best Solution','Numbertitle','off');
        hAx = gca;
    end
    if showWaitbar
